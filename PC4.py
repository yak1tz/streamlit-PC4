...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Aprendiendo con Phyton </h1>", unsafe_allow_html=True)
    ...
    col1.image("hori.jpg", caption= 'yaki', width=300)
    ...
    texto = """
    Soy Jacqueline Changa, pero me gusta que me digan yaki. Soy de Lima, Perú, y vivo en Carabayllo. 
    Estudio Comunicaciones Audiovisuales y gusta que puedo desenvolverme en muchas cosas y manejar cámaras.
    En un futuro me encantaría poder ser directora profesional y trabajar en una productora de cine reconocida.
    En mis tiempos libres me gusta jugar videojuegos como Valorant y Minecraft, preparar postres, escuchar música y ver series y anime.
    """
    col3. image('valo.jpg', caption= "valo", width=250)
    col4. image("jeje.jpg", caption= "Me before you", width=300)
    ...
    texto_2 = """
    Aprender a programar ha sido un reto, pero también una experiencia muy satisfactoria. 
    Al principio me costó entender algunos conceptos, pero con práctica fui mejorando. 
    Me gustó ver cómo mi código se convierte en algo real y visual, y aprendí que programar requiere paciencia, lógica y constancia.
    """
    ...
    st.markdown("<h2 style='text-align: center;'>Diferencias entre los bucles for y while</h2>", unsafe_allow_html=True)
    st.video("https://youtu.be/Fyhs0UXxxrs")
    st.markdown("<h2 style='text-align: center;'>Declaraciones condicionales if-elif-else</h2>", unsafe_allow_html=True)
    st.video("https://youtu.be/xXZ57P2uKp8")
    # <h2 style='text-align: center;'>Diferencias entre los bucles for y while</h2>: Esta es una cadena de código HTML.
    ...
    graficos = ['Gráfico de barras del promedio de tarjetas rojas recibidas por equipo como local', 'Gráfico de barras de goles anotados del Barcelona como local', 'Gráfico pastel comparando los resultados del Real Madrid como visitante y local', 'Mapa de mis pelis favoritas']
